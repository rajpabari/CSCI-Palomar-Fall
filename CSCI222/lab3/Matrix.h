...
public:
  ...
  // @param Matrix& the matrix to be incremented
  ...
  // @param Matrix& the matrix to be incremented
  // @return Matrix& pointer to copy of the original matrix
  friend Matrix &operator++(Matrix &, int unused);

  // Prefix decrement - decrement each value of matrix by 1,
  // then returns the decremented matrix
  // @param Matrix& the matrix to be decremented
  ...
  // then returns the original matrix
  // @param Matrix& the matrix to be decremented
  // @return Matrix& pointer to original matrix
  friend Matrix &operator--(Matrix &, int unused);
